...
class Validator{
    ...
    static $DATE_FORMAT = 'd-m-Y g:i a';
    ...
    protected $messages = [
        ...
        'regex'     => 'The :item field is wrong',
        'date'      => 'The :item field must be valid date.',
    ];
    ...
    protected function validateRegex($item, $value, $param = null)
    {
        return preg_match("/" . $value . "/i", $param);
    }
    ...
    protected function validateDate($item, $value, $param = null)
    {
        $d = DateTime::createFromFormat(self::$DATE_FORMAT, $value);
        return $d && $d->format(self::$DATE_FORMAT) === $value;
    }

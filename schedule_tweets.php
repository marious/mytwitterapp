...
<div class="col-md-9">
    <div class="panel panel-default">
        <div class="panel-heading fs-18"><span class="fa fa-twitter fa-fw"></span> التغريدات المجدولة </div>
        <div class="panel-body">
            ...
            <div><a href="#" class="btn btn-primary" data-toggle="modal" data-target="#createTwittModal" id="create_tweet">عمل تغريدة جديدة</a></div>
            <br>
            <table class="table table-bordered table-striped" id="scheduled_tweets">
                <thead>
                    <tr>
                        <th>وقت التغريد</th>
                        <th>محتوى التغريدة</th>
                        <th>الملف المرفق</th>
                        <th>تعديل</th>
                        <th>حذف</th>
                    </tr>
